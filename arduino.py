...
# define ALARM LED pin as Digital Output Pin 7
alarm_led_pin = board.get_pin('d:7:o')
...
while True:
    ...
    # join array of data as a single comma seperated string
    data = ','.join(data)

# publish the data to MQTT broker using the topic
